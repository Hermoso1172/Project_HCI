...
<body>
    ...
    <div class="navigations">
        ...
        <ul>
            ...
            <li><a href="Editor-History.php">History</a></li>
            <li class="genre-selected"><a href="Editor-Fantasy.php">Fantasy</a></li>
        </ul>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php
                $selectSCIENCE = mysqli_query($conn, "SELECT * FROM books WHERE category = 'FANTASY'");
